...
import { createInherentEffect, applyTalentActiveEffects as applyTalentAEs, applyImportActiveEffects } from "./import-ae-utils.js";
import {
...
import {
  minionTemplate as minionTemplateData,
  characterTemplate as characterTemplateData,
...
export default class ImportHelpers {
  ...
  static minionTemplate = minionTemplateData;
  static characterTemplate = characterTemplateData;
  ...
  static async applyActiveEffectOnUpdate(item, formData) {
    return applyImportActiveEffects(item, formData);
  }
