...
import { RivalSheet } from "./sheets/actor/rival-sheet.js";
import { NemesisSheet } from "./sheets/actor/nemesis-sheet.js";
import { CharacterSheet } from "./sheets/actor/character-sheet.js";
import { AbilitySheet } from "./sheets/item/ability-sheet.js";
import { ArmourSheet } from "./sheets/item/armour-sheet.js";
import { BackgroundSheet } from "./sheets/item/background-sheet.js";
import { CareerSheet } from "./sheets/item/career-sheet.js";
import { CriticaldamageSheet } from "./sheets/item/criticaldamage-sheet.js";
import { CriticalinjurySheet } from "./sheets/item/criticalinjury-sheet.js";
import { ForcepowerSheet } from "./sheets/item/forcepower-sheet.js";
import { GearSheet } from "./sheets/item/gear-sheet.js";
import { HomesteadupgradeSheet } from "./sheets/item/homesteadupgrade-sheet.js";
import { ItemattachmentSheet } from "./sheets/item/itemattachment-sheet.js";
import { ItemmodifierSheet } from "./sheets/item/itemmodifier-sheet.js";
import { MotivationSheet } from "./sheets/item/motivation-sheet.js";
import { ObligationSheet } from "./sheets/item/obligation-sheet.js";
import { ShipattachmentSheet } from "./sheets/item/shipattachment-sheet.js";
import { ShipweaponSheet } from "./sheets/item/shipweapon-sheet.js";
import { SignatureabilitySheet } from "./sheets/item/signatureability-sheet.js";
import { SpecializationSheet } from "./sheets/item/specialization-sheet.js";
...
Hooks.once("init", async function () {
  ...
  foundry.documents.collections.Actors.registerSheet("ffg", RivalSheet, { types: ["rival"], makeDefault: true, label: "Rival Sheet" });
  ...
  foundry.documents.collections.Items.registerSheet("ffg", CareerSheet, { types: ["career"], makeDefault: true, label: "Career Sheet" });
  foundry.documents.collections.Items.registerSheet("ffg", CriticaldamageSheet, { types: ["criticaldamage"], makeDefault: true, label: "Critical Damage Sheet" });
  foundry.documents.collections.Items.registerSheet("ffg", CriticalinjurySheet, { types: ["criticalinjury"], makeDefault: true, label: "Critical Injury Sheet" });
  foundry.documents.collections.Items.registerSheet("ffg", ForcepowerSheet, { types: ["forcepower"], makeDefault: true, label: "Force Power Sheet" });
  foundry.documents.collections.Items.registerSheet("ffg", GearSheet, { types: ["gear"], makeDefault: true, label: "Gear Sheet" });
  foundry.documents.collections.Items.registerSheet("ffg", HomesteadupgradeSheet, { types: ["homesteadupgrade"], makeDefault: true, label: "Homestead Upgrade Sheet" });
  foundry.documents.collections.Items.registerSheet("ffg", ItemattachmentSheet, { types: ["itemattachment"], makeDefault: true, label: "Item Attachment Sheet" });
  foundry.documents.collections.Items.registerSheet("ffg", ItemmodifierSheet, { types: ["itemmodifier"], makeDefault: true, label: "Item Modifier Sheet" });
  foundry.documents.collections.Items.registerSheet("ffg", MotivationSheet, { types: ["motivation"], makeDefault: true, label: "Motivation Sheet" });
  foundry.documents.collections.Items.registerSheet("ffg", ObligationSheet, { types: ["obligation"], makeDefault: true, label: "Obligation Sheet" });
  foundry.documents.collections.Items.registerSheet("ffg", ShipattachmentSheet, { types: ["shipattachment"], makeDefault: true, label: "Ship Attachment Sheet" });
  foundry.documents.collections.Items.registerSheet("ffg", ShipweaponSheet, { types: ["shipweapon"], makeDefault: true, label: "Ship Weapon Sheet" });
  foundry.documents.collections.Items.registerSheet("ffg", SignatureabilitySheet, { types: ["signatureability"], makeDefault: true, label: "Signature Ability Sheet" });
  foundry.documents.collections.Items.registerSheet("ffg", SpecializationSheet, { types: ["specialization"], makeDefault: true, label: "Specialization Sheet" });
  foundry.documents.collections.Items.registerSheet("ffg", SpeciesSheet, { types: ["species"], makeDefault: true, label: "Species Sheet" });
  foundry.documents.collections.Items.registerSheet("ffg", TalentSheet, { types: ["talent"], makeDefault: true, label: "Talent Sheet" });
  foundry.documents.collections.Items.registerSheet("ffg", WeaponSheet, { types: ["weapon"], makeDefault: true, label: "Weapon Sheet" });
...
export { itemPillHover } from "./helpers/item-pill-hover.js";
